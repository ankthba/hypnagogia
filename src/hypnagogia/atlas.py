...
def build_atlas(conn: Connectome, out_dir: Path, max_neurons: int | None = None, seed: int = 0) -> dict:
    ...
    side = {
        ...
        "provenance": {"config": "configs/base.yaml", "results_dir": "data/cache",
                       "files": ["data/raw/malecns/body-annotations-male-cns-v1.0-minconf-0.5.feather"],
                       "written_by": "src/hypnagogia/atlas.py via scripts/export_web.py"},
